    ...
    <div className="flex h-screen bg-gray-100 overflow-hidden">
      ...
      >
        ...
        <nav className="px-4 py-4 text-gray-400 space-y-1 overflow-y-auto">
          <SidebarLink title="Dashboard" href="/optional2/dashboard" pathname={pathname} Icon={LayoutDashboard} />
          <SidebarLink title="Portfolio" href="/optional2/portfolio" pathname={pathname} Icon={GalleryHorizontal}/>
          <SidebarLink title="Skill Passport" href="/optional2/skill-passport" pathname={pathname} Icon={TicketCheck} />
