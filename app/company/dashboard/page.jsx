         ...
         <div className=" space-y-6">
            ...
            <section className=" pt-6 px-6 rounded-xl flex justify-between items-center">
              <div className="flex items-center gap-4">
                <img src="/images/logo" alt="logo"  className="w-20 h-20 bg-white rounded-lg"  /> 
                <div>
                  <h1 className="text-3xl text-gray-500 font-bold capitalize">
                    NextGen
                  </h1>
          ...
          <main className="max-w-7xl mx-auto p-6 grid grid-cols-1 lg:grid-cols-3 gap-6 ">
            ...
            <section className="bg-white p-6 rounded-xl">
              ...
              {[
                ...
                <div
                  key={job.role}
                  className="flex justify-between items-center bg-green-100 border-2 border-green-200 rounded-lg p-4 mb-3"
                >
                  <div className="">
                  ...
                  <p className="text-sm text-gray-500">UI Design</p>
                   <button className="text-white-300 rounded  text-sm bg-blue-500 hover:bg-blue-700 px-3 py-1">Trial</button>
                  
                  
                  </div>
                  <div className="flex">
                    <button className="text-white-300 rounded mt-3 text-sm bg-blue-500 hover:bg-blue-700 px-2 py-1 me-3">Programming</button>
                    <button className="text-white-300 rounded mt-3 text-sm bg-green-500 hover:bg-green-700 px-3 py-1">Problem Solving</button>
                  </div>
                  </div>
            ...
            <section className="bg-white p-6 rounded-xl">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {["Mobile App Redesign", "E-Commerce Campaign"].map(p => (
                  <div
                    key={p}
                    className="border bg-green-100 rounded-lg p-4 hover:shadow"
                  >
                    <h3 className="font-semibold text-gray-500">{p}</h3>
                   <div className="">
                    <button className="text-white-300 rounded mt-3 text-sm bg-blue-500 hover:bg-blue-700 px-2 py-1 me-3">UI Design</button>
                    <button className="text-white-300 rounded mt-3 text-sm bg-green-500 hover:bg-green-700 px-3 py-1">Trial</button>
                   </div>
                   <div className="flex justify-end items-center mt-4 me-4 border-t border-gray-300">
                    <button className="text-white-300 rounded mt-2 text-sm bg-blue-600 hover:bg-blue-700 px-5 py-2">View More  </button>
                  </div>
                  </div>   
                ))}
          ...
          <aside className="space-y-6">
            ...
            <div className="bg-white p-5 -mt-6 rounded-xl">
              <div className="flex items-center gap-4">
                <img src="/images/growth" alt="growth"  className="w-20 h-24 bg-gray-200  rounded-lg"  /> 
                <div>
                  ...
                  <div className="">
                     <button className="text-white-300 rounded mt-2 text-sm bg-blue-400 hover:bg-blue-500 px-2 py-1 me-3">proggraming</button>
                    <button className="text-white-300 rounded mt-2 text-sm bg-blue-400 hover:bg-blue-500 px-3 py-1">Feedback loops</button>
                  </div> 
            ...
            <div className="bg-white p-5 rounded-xl">
              ...
              <img src="/images/graph" alt="" className="h-30 bg-gray-100 rounded mt-3" />

               <div className="flex justify-end items-center mt-4 me-4 border-t border-gray-300">
                    <button className="text-white-300 rounded mt-2 text-sm bg-blue-600 hover:bg-blue-700 px-5 py-2">View Report  </button>
                  </div>
            </div>
